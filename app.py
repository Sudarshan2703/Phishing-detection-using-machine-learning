...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('We used  different ML classifiers of scikit-learn and tested them implementing k-fold cross validation.'
             'so these are the models which we have used for prediction')
...
with st.expander('EXAMPLE PHISHING URLs:'):
    st.write('https://post.ch-die.com/index.html')
    st.write('https://simply-plans.com/')
    st.write('https://www.herecomesthepups.com/')
